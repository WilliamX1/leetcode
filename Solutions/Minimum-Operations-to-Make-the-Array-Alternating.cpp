...
class Solution
{
  public:
    int minimumOperations(vector<int> &nums)
    {
        ...
        sort(odd_v.begin(), odd_v.end(), [](const vector<int> &A, const vector<int> &B) { return A[1] > B[1]; });
        sort(even_v.begin(), even_v.end(), [](const vector<int> &A, const vector<int> &B) { return A[1] > B[1]; });
