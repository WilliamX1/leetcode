  ...
  public:
    vector<bool> canEat(vector<int> &candiesCount, vector<vector<int>> &queries)
    {
        ...
        for (int i = 0; i < m; i++)
        {
            ...
            answer[i] =
                favoriteDayi < presum[favoriteTypei + 1] && presum[favoriteTypei] < (favoriteDayi + 1) * dailyCapi;
        };
...
int main()
{
    vector<int> candiesCount = {46, 5,  47, 48, 43, 34, 15, 26, 11, 25, 41, 47, 15, 25, 16, 50, 32, 42, 32, 21,
