  ...
  public:
    ...
    int maxHappyGroups(int batchSize, vector<int> &groups)
    {
        ...
        for (int i = arr.size() - 1; i >= 0; i--)
            if (flag[i] == false)
                recurse(flag, arr, batchSize, i, batchSize, ans);
...
{
    Solution S;
    vector<int> v = {145326640, 622724151, 591814792, 827053040, 111964428, 344376875, 42023891,  436582274, 78590835,
